...
export default function FormEdit({route}) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setNamaLengkap(json.namalengkap2010041);
        setJenisKelamin(json.jenkel2010041);
        setTempatLahir(json.tmp_lahir2010041);
        setTanggalLahir(new Date(json.tgl_lahir2010041));
        setAlamat(json.alamat2010041);
        setNoTelp(json.notelp2010041);
      } catch (error) {
  ...
  const submitForm = async () => {
    ...
    const formData = {
      ...
      tgl_lahir2010041: tanggalLahir.toISOString().split('T')[0], // Format to YYYY-MM-DD
      alamat2010041: alamat_2010041,
      ...
      Alert.alert('Success', 'Data dosen ini berhasil di-Update', [
        {
          text: 'Ok',
          onPress: () =>
            navigation.navigate('DetailDosen', {nidn2010041: nidn2010041}),
        },
      ]);
    } catch (error) {
      // Handle failure
