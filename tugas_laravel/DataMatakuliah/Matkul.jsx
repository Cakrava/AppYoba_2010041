  ...
  const renderItemMatkul = ({item}) => {
    const showDetailMatkul = () => {
      navigation.navigate('DetailMatkul', {
        kdmatkul2010041: item.kdmatkul2010041,
      });
    };
    return (
      <View style={styles.item}>
        <Text style={styles.titleNim}>{item.kdmatkul2010041}</Text>
        <Text style={styles.text}>{item.namamat2010041}</Text>
        <TouchableOpacity
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        keyExtractor={item => item.kdmatkul2010041}
